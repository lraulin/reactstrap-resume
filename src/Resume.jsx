              ...
              <article id="resume">
                ...
                <section id="summarySection">
                  ...
                  <p>
                    ...
                    experience as an English as a Second Language teacher in
                    Korea and one year of experience as a web developer working
                    under contract for the US Department of Transportation.
                  </p>
                  <p>
                    Extremely motivated and passionate life-long learner. Have
                    been using Linux as primary operating system for almost a
                    decade. Learned Python as a hobby, and learned how to use
                    Vim because it seemed neat. After deciding to become a
                    programmer, I spent a year of full-time practice/self-study
                    before being accepted by WOS. In the year since then, my
                    skills with JavaScript and Python have continued to develop,
                    as I have become familiar with the languages in depth and
                    used them to create solutions to real-world problems.
                  </p>
                </section>
                ...
                <section id="experienceSection">
                  ...
                  <ul>
                    <li>
                      Developed, designed, coded, debugged, and documented one
                      web application and multiple console applications.
                    </li>
                    <li>
                  ...
                  <ul>
                    <li>
                      <p>
                        ...
                        only to the front-end code) using JavaScript (ES6),
                        React, Redux, AWS (E2, RDS, S5), PostgreSQL, Mapbox,
                        etc. Deployed to Firebase, AWS, and Vultr (cloud VM) as
                        staging environment. Calculated projected costs and
                        prepared budget proposal for AWS infrastructure, which
                        was accepted.
                      </p>
                    </li>
                  </ul>
                  <ul>
                    <li>
                      <p>
                        ...
                        NodeJS/SQLite console app that automated checking
                        hundreds of DNS servers every hour and emailing a daily
                        summary of any discrepancies. Deployed to a government
                        BIND (Linux) server.
                      </p>
                    </li>
                    <li>
                      <p>
                        ...
                        Programmed a Python script that triggers on receipt of
                        an email by a MS 365 account containing a report on
                        security vulnerabilities. It extracts files attached to
                        the PDF file attached to the email, reformats the
                        spreadsheets, including calculated values, and emails
                        them to a distribution list.
                      </p>
                    </li>
                    <li>
                      <p>
                        <a href="/projects/syslog_analytics">
                          Syslog Analytics
                        </a>{" "}
                        Composed Python script to parse/reformat spreadsheet
                        files to support cyber team.
                      </p>
                    </li>
                    <li>
